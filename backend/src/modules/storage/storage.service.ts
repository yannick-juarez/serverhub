      ...
      masks: [
        {
          ...
          name: 'Matin',
          type: 'native',
          slots: [0,1,2,3,4,5,6].map(day => ({ day, start: '06:00', end: '12:00' })),
          operations: [],
          created_at: now,
          updated_at: now,
        },
        {
          ...
          name: 'Midi',
          type: 'native',
          slots: [0,1,2,3,4,5,6].map(day => ({ day, start: '12:00', end: '14:00' })),
          operations: [],
          created_at: now,
          updated_at: now,
        },
        {
          ...
          name: 'Après-midi',
          type: 'native',
          slots: [0,1,2,3,4,5,6].map(day => ({ day, start: '14:00', end: '19:00' })),
          operations: [],
          created_at: now,
          updated_at: now,
        },
        {
          mask_id: 'native-dinner',
          name: 'Dîner',
          type: 'native',
          slots: [0,1,2,3,4,5,6].map(day => ({ day, start: '19:00', end: '21:00' })),
          operations: [],
          created_at: now,
          updated_at: now,
        },
        {
          ...
          name: 'Soirée',
          type: 'native',
          slots: [0,1,2,3,4,5,6].map(day => ({ day, start: '21:00', end: '23:00' })),
          operations: [],
          created_at: now,
          updated_at: now,
        },
        {
          ...
          name: 'Journée',
          type: 'native',
          slots: [1,2,3,4,5].map(day => ({ day, start: '08:00', end: '20:00' })),
          operations: [],
          created_at: now,
          updated_at: now,
        },
